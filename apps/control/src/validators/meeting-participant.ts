...
// Enums
export const MeetingParticipantRole = z.enum(['HOST', 'PARTICIPANT', 'OBSERVER']);
...
export const createMeetingParticipantSchema = createMeetingParticipantBaseSchema.refine(
  (data) => data.userId || (data.externalName && data.externalEmail),
  { message: 'Either userId or both externalName and externalEmail are required' }
);
...
// Type exports
export type CreateMeetingParticipantInput = z.infer<typeof createMeetingParticipantSchema>;
