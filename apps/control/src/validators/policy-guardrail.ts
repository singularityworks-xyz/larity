...
// Enums
export const GuardrailRuleType = z.enum([
  "NDA",
  "LEGAL",
  "TERMINOLOGY",
  "INTERNAL",
...
export const GuardrailSourceType = z.enum([
  "DECISION",
  "IMPORTANT_POINT",
  "MANUAL",
]);
...
// Type exports
export type CreatePolicyGuardrailInput = z.infer<
  typeof createPolicyGuardrailSchema
>;
export type UpdatePolicyGuardrailInput = z.infer<
  typeof updatePolicyGuardrailSchema
>;
