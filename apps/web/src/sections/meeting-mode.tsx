      ...
      <div className="mx-auto max-w-7xl px-6 md:px-8">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="relative mt-16 w-full">
            ...
            {cards.map((card) => (
              <div
                ...
                key={`float-${card.id}`}
              >
                <div className="rounded-xl border border-accent/15 bg-[#f7f4ea]/90 p-4 shadow-[0_8px_30px_rgb(0,0,0,0.06)] backdrop-blur-md transition-all duration-300 hover:border-accent/40 hover:bg-[#f7f4ea]/95 hover:shadow-[0_12px_40px_rgb(0,0,0,0.1)]">
          ...
          <div className="mt-12 grid w-full grid-cols-1 gap-6 text-left sm:grid-cols-2 md:hidden">
            {cards.map((card) => (
              <div
                className="rounded-xl border border-accent/10 bg-[#f7f4ea] p-5 shadow-sm"
                key={`mobile-${card.id}`}
              >
                <div className="flex items-center gap-2">
                  {card.icon}
