...
export function AlertCard({
  ...
  return (
    <div
      className={`relative flex w-full flex-col rounded-2xl border border-border/50 text-sm ${bgClass} overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.12)] backdrop-blur-xl ${isExiting ? "alert-card-exit" : "alert-card-enter"}`}
      style={style}
    >
